...
export default function About() {
  return (
    ...
    <div className='about-text'>
      ...
      <p>Sed diam felis, lobortis at volutpat non, fermentum et turpis. Sed et quam in mi tristique cursus quis eget metus. Morbi sapien justo, feugiat id turpis ultrices, rutrum finibus velit. Cras eget lorem nec justo volutpat volutpat sed eu augue. Nunc vel congue leo. Aliquam erat volutpat. Aenean posuere, tellus eu rutrum pharetra, erat mi gravida elit, et commodo mi metus faucibus justo. Etiam imperdiet mollis tellus, eget consequat ipsum hendrerit interdum. Praesent mattis laoreet est a ultrices. Integer massa est, sagittis in accumsan at, molestie vitae orci. Curabitur venenatis nisi sapien, quis molestie nisl laoreet ac. Integer sed placerat purus.</p>
    </div>
    </div>
		</>
	);
